...
(function() {
        ...
        roomsList.innerHTML = `
            <div class="room-card skeleton-card">
                <div class="room-host">
                    ...
                    <div class="skeleton sk-w-72 sk-h-12"></div>
                    <div class="skeleton sk-w-40 sk-h-12"></div>
                </div>
                <div class="room-info">
                    <div class="skeleton sk-w-130 sk-h-14 sk-mb-8"></div>
                    <div class="skeleton sk-w-180 sk-h-12"></div>
                </div>
            ...
            <div class="room-card skeleton-card">
                <div class="room-host">
                    <div class="skeleton skeleton-avatar"></div>
                    <div class="skeleton sk-w-84 sk-h-12"></div>
                    <div class="skeleton sk-w-38 sk-h-12"></div>
                </div>
                <div class="room-info">
                    <div class="skeleton sk-w-140 sk-h-14 sk-mb-8"></div>
                    <div class="skeleton sk-w-200 sk-h-12"></div>
                </div>
                <span class="skeleton skeleton-pill"></span>
            </div>
            <div class="room-card skeleton-card">
                <div class="room-host">
                    <div class="skeleton skeleton-avatar"></div>
                    <div class="skeleton sk-w-66 sk-h-12"></div>
                    <div class="skeleton sk-w-44 sk-h-12"></div>
                </div>
                <div class="room-info">
                    <div class="skeleton sk-w-118 sk-h-14 sk-mb-8"></div>
                    <div class="skeleton sk-w-168 sk-h-12"></div>
                </div>
                <span class="skeleton skeleton-pill"></span>
            </div>
        `;
    ...
    async function handleRoomClick(card) {
        ...
        if (isFull && !isPlaying) {
            try {
                const latest = await API.get(`/chess/rooms/${roomId}/`);
                if (latest?.guest) {
                    Toast.error('이미 인원이 가득 찼습니다.');
                    return;
                }
            } catch {
                Toast.error('방 정보를 확인할 수 없습니다.');
                return;
            }
        }

        if (isPlaying) {
            const target = currentView === 'spectate' ? `/games/${roomId}/spectate/` : `/games/${roomId}/`;
