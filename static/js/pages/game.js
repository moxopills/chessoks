...
(function() {
    ...
    function getPieceShapeSet(variant) {
        const classic = {
            p: `
                <circle cx="32" cy="15.5" r="5.8"></circle>
                <rect x="29.6" y="21.2" width="4.8" height="5.2" rx="2"></rect>
                <path d="M25.2 33.8c0-5.8 3.1-9.8 6.8-9.8s6.8 4 6.8 9.8v2.8H25.2z"></path>
                <rect x="22.2" y="36.4" width="19.6" height="8.7" rx="4.2"></rect>
                <rect x="18.2" y="46.8" width="27.6" height="2.8" rx="1.4"></rect>
                <rect x="16.8" y="49.8" width="30.4" height="3.4" rx="1.7"></rect>
            `,
            r: `
                <rect x="17" y="12.4" width="6" height="8" rx="1"></rect>
                <rect x="29" y="12.4" width="6" height="8" rx="1"></rect>
                <rect x="41" y="12.4" width="6" height="8" rx="1"></rect>
                <rect x="17" y="20.6" width="30" height="5.2" rx="1.8"></rect>
                <rect x="21.4" y="26.8" width="21.2" height="17.8" rx="2.2"></rect>
                <rect x="18.2" y="46.8" width="27.6" height="2.8" rx="1.4"></rect>
                <rect x="16.8" y="49.8" width="30.4" height="3.4" rx="1.7"></rect>
            `,
            n: `
                <path d="M16.8 49.8h30.4v3.4H16.8z"></path>
                <path d="M18.2 46.8h27.6v2.8H18.2z"></path>
                <path d="M21.2 44.2c5.8-.6 9.9-2.3 12.6-5.3 2.3-2.5 3.6-6 3.8-10.2
                -2.6 1-5 .8-6.9-.8-.1-4.7 2.9-8.8 8.6-12.2l7.3 6.6-2.2 6.5c2.7 1.3 4.2 3.8 4.7 7.4-1 5.4-5.8 7.9-14.5 8z"></path>
                <circle cx="37.2" cy="23.4" r="1.8" class="piece-eye"></circle>
            `,
            b: `
                <ellipse cx="32" cy="16.2" rx="6.2" ry="8.2"></ellipse>
                <path d="M30.3 13.2h3.4l-1.8 6.3h-1.2z"></path>
                <rect x="30.9" y="22.6" width="2.2" height="4.4" rx="1.1"></rect>
                <path d="M25.3 33.8c0-6.6 3.1-10.7 6.7-10.7s6.7 4.1 6.7 10.7v2.9H25.3z"></path>
                <rect x="22.2" y="36.2" width="19.6" height="8.8" rx="4.2"></rect>
                <rect x="18.2" y="46.8" width="27.6" height="2.8" rx="1.4"></rect>
                <rect x="16.8" y="49.8" width="30.4" height="3.4" rx="1.7"></rect>
            `,
            q: `
                <circle cx="19.4" cy="16.2" r="2.5"></circle>
                <circle cx="27.3" cy="13.2" r="2.5"></circle>
                <circle cx="36.7" cy="13.2" r="2.5"></circle>
                <circle cx="44.6" cy="16.2" r="2.5"></circle>
                <path d="M19.4 21.8l5.1 13.7h15l5.1-13.7-6.5 4.7-6.1-6.4-6.1 6.4z"></path>
                <rect x="22.2" y="36.2" width="19.6" height="8.7" rx="4.1"></rect>
                <rect x="18.2" y="46.8" width="27.6" height="2.8" rx="1.4"></rect>
                <rect x="16.8" y="49.8" width="30.4" height="3.4" rx="1.7"></rect>
            `,
            k: `
                <rect x="30.9" y="8.2" width="2.2" height="8.8" rx="1"></rect>
                <rect x="26.6" y="11.5" width="10.8" height="3" rx="1.2"></rect>
                <path d="M25.1 33.7c0-7.6 3.1-11.6 6.9-11.6s6.9 4 6.9 11.6v2.8H25.1z"></path>
                <rect x="22.2" y="36.1" width="19.6" height="8.9" rx="4.2"></rect>
                <rect x="18.2" y="46.8" width="27.6" height="2.8" rx="1.4"></rect>
                <rect x="16.8" y="49.8" width="30.4" height="3.4" rx="1.7"></rect>
            `,
        };
