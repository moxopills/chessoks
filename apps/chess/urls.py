...
urlpatterns = [
    ...
    path("puzzle/daily/", DailyPuzzleView.as_view(), name="puzzle-daily"),
    path("puzzle/daily/move/", DailyPuzzleMoveView.as_view(), name="puzzle-daily-move"),
    path("puzzle/daily/hint/", DailyPuzzleHintView.as_view(), name="puzzle-daily-hint"),
    path("puzzle/daily/solution/", DailyPuzzleSolutionView.as_view(), name="puzzle-daily-solution"),
    path("puzzle/stats/", PuzzleStatsView.as_view(), name="puzzle-stats"),
    path("puzzle/streak/", PuzzleStreakView.as_view(), name="puzzle-streak"),
    ...
    path("games/<int:game_id>/summary/", GameSummaryView.as_view(), name="game-summary"),
