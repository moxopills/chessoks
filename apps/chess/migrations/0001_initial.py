    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "room_type",
                    models.CharField(
                        choices=[("quick", "빠른 대전"), ("custom", "사용자 방")],
                        default="custom",
                ...
                (
                    "time_limit",
                    models.IntegerField(default=30, help_text="각 플레이어당 시간 제한 (분)"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pgn",
                    models.TextField(
                        blank=True, help_text="PGN(Portable Game Notation) 형식의 게임 기록"
                    ),
                ),
                (
                    "result",
                ...
                (
                    ...
                    models.IntegerField(help_text="백 플레이어 남은 시간 (초)"),
                ),
                (
                    "black_time_remaining",
                    models.IntegerField(help_text="흑 플레이어 남은 시간 (초)"),
                ),
                (
                    "current_turn",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uci",
                    models.CharField(help_text="Universal Chess Interface notation", max_length=5),
                ),
                (
                    "is_capture",
                    models.BooleanField(default=False, help_text="기물을 잡았는지 여부"),
                ),
                ("is_check", models.BooleanField(default=False, help_text="체크 상태인지 여부")),
                (
                    "is_checkmate",
                    models.BooleanField(default=False, help_text="체크메이트 상태인지 여부"),
                ),
                (
                    "is_castling",
                    models.BooleanField(default=False, help_text="캐슬링 착수인지 여부"),
                ),
                (
                    "is_en_passant",
                    models.BooleanField(default=False, help_text="앙파상 착수인지 여부"),
                ),
                (
                    "promotion",
                    models.CharField(
                ...
                (
                    "fen_after_move",
                    models.CharField(help_text="착수 후 보드 상태 (FEN)", max_length=100),
                ),
                (
                    "time_spent",
                    models.FloatField(
                        blank=True, help_text="이번 착수에 소요된 시간 (초)", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["game", "move_number"], name="moves_game_id_325edd_idx"),
                    models.Index(fields=["game", "created_at"], name="moves_game_id_d4d651_idx"),
                ],
        ...
        migrations.AddIndex(
            model_name="game",
            index=models.Index(
                fields=["white_player", "black_player"], name="games_white_p_1742a4_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="game",
